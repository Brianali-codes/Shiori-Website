...
export function NavigationMenuDemo() {
  return (
    <div className="flex justify-between items-center shadow-sm px-6 py-4 bg-white">
                ...
                <ul className="grid gap-2 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                  <li className="row-span-3">
                    <NavigationMenuLink asChild>
                      <a
                        className="flex h-full w-full flex-col justify-end rounded-md bg-gradient-to-b from-muted/50 to-muted p-6 no-underline select-none focus:shadow-md"
                        href="/"
                      >
